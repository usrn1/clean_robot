...
struct Lane_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::styx_msgs::Waypoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::styx_msgs::Waypoint_<ContainerAllocator> >> _waypoints_type;
...
bool operator==(const ::styx_msgs::Lane_<ContainerAllocator1> & lhs, const ::styx_msgs::Lane_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::styx_msgs::Lane_<ContainerAllocator> >
{
  ...
  {
    return "2e6b81cde5255df9c6ad5875bb651461";
  }

  static const char* value(const ::styx_msgs::Lane_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2e6b81cde5255df9ULL;
  static const uint64_t static_value2 = 0xc6ad5875bb651461ULL;
};
