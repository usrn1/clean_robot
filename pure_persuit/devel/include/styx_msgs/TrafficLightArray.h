...
struct TrafficLightArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::styx_msgs::TrafficLight_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::styx_msgs::TrafficLight_<ContainerAllocator> >> _lights_type;
  _lights_type lights;
...
bool operator==(const ::styx_msgs::TrafficLightArray_<ContainerAllocator1> & lhs, const ::styx_msgs::TrafficLightArray_<ContainerAllocator2> & rhs)
{
